...
//   return (
//     <div>
//       <button className="bg-pink-200 hover:bg-pink-300 cursor-pointer px-2 py-1 w-full text-left flex items-center gap-2 sticky top-0 z-10">
//         <div className="size-4">
//           <LuChevronRight className="size-4 rotate-90" />
//         </div>
//         <div className="text-sm">Step</div>
...
//           <div
//             key={i}
//             className="px-2 text-sm font-mono py-0.5 hover:bg-black/5"
//           >
//             Line
//           </div>
//         ))}*/}
