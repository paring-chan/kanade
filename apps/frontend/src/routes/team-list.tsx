...
const TeamItem = ({ team }: { team: components['schemas']['TeamResponse'] }) => {
	return (
		<Link
					...
					<div className={dialog.content()}>
						<form.Field
							...
							children={(field) => (
								...
								>
									<Field.Label className={formField.label()}>팀 이름</Field.Label>
						...
						<form.Field
							...
							children={(field) => (
								<Field.Root
									...
									touched={field.state.meta.isTouched}
								>
									<Field.Label className={formField.label()}>팀 슬러그</Field.Label>
									<Field.Control className={input()} value={field.state.value} onValueChange={field.handleChange} onBlur={field.handleBlur} placeholder="example-team" />
									<div className={formField.helperArea()}>
